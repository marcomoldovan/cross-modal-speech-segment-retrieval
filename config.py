...
class ParallelSpeechAndTextModelConfig(PretrainedConfig):
  """
  This is the configuration class for pre-training the ParallelSpeechAndTextModel. It holds
  ...
  Args:
    ...
    wav2vec2_pretrained_name (str): name of the pretrained wav2vec2 model to use
